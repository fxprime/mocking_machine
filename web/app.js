...
const parameterDefinitions = {
  ...
  feedbackLimit: { id: 24, decimals: 3, step: 0.01, min: 0.001, max: 1, description: "Maximum PID feedback correction added to or subtracted from feedforward duty" },
  estimatorMinCounts: { id: 25, decimals: 0, step: 1, min: 1, max: 32, description: "Count threshold where the velocity estimator favors count-over-time measurement" },
  estimatorMaxWindowUs: { id: 26, decimals: 0, step: 1000, min: 1000, max: 500000, description: "Maximum count-estimation window in microseconds" },
  estimatorStaleTimeoutUs: { id: 27, decimals: 0, step: 1000, min: 1000, max: 2000000, description: "Time after the last encoder edge before estimated velocity decays to zero, in microseconds" },
