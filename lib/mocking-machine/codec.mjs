...
function decodeSettings(reader) {
  ...
  return {
    ...
    positionKp: reader.optional(204, 4, () => reader.f32(204), 5),
    positionKi: reader.optional(208, 4, () => reader.f32(208), 0),
    positionKd: reader.optional(212, 4, () => reader.f32(212), 0.15),
    positionMaximumVelocityRadS:
      reader.optional(216, 4, () => reader.f32(216), 20),
    positionToleranceDeg: reader.optional(220, 4, () => reader.f32(220), 1),
    positionSettleVelocityRadS:
      reader.optional(224, 4, () => reader.f32(224), 0.5),
    positionSettleTimeMs: reader.optional(228, 4, () => reader.u32(228), 250),
    positionMinimumVelocityForwardRadS:
      reader.optional(232, 4, () => reader.f32(232), 1),
    positionMinimumVelocityReverseRadS:
      reader.optional(236, 4, () => reader.f32(236), 1)
  };
}
...
export function encodePositionTarget(targetPositionDeg) {
  const target = Number(targetPositionDeg);
  if (!Number.isFinite(target) || target < 0 || target >= 360) {
    throw new RangeError("targetPositionDeg must be in [0, 360)");
  }
  return encodeFloat32(target);
}
