...
enum class MessageId : uint16_t {
  ...
  SetDefaultProfile = 0x0125,
  GetLoadConfiguration = 0x0130,
  LoadConfiguration = 0x0131,
  SetLoadConfiguration = 0x0132,
  GetBearingConfiguration = 0x0133,
  BearingConfiguration = 0x0134,
  SetBearingConfiguration = 0x0135,
  StartRun = 0x0200,
  StopRun = 0x0201,
  MotorTest = 0x0202,
  ClearFaults = 0x0203,
